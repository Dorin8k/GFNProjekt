...
def test_haushaltsverwaltung():
    ...
    eintraege = verwaltung.fetchAllEintraege(1, filter_date='2025-01-11')
    print(eintraege)
    ...
    print("\nTest 10: Eintrag umbenennen")
    verwaltung.renameEintrag(1, 1, 'Neues Gehalt', 3000, 'Arbeit', 'Einkommen', '2025-01-12')
    eintraege = verwaltung.fetchAllEintraege(1)
    print(eintraege)
